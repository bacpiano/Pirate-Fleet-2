...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! He will get one of your ship :("
        static let ComputerHitMonster = "The computer has hit a sea monster! He'll make sure to get one of computer's ship for you :)"
